...
public class Main {
    public static void main(String[] args) {
        ...
        // Trocamos para a sua nova classe circular
        ListaCircularNinja equipe = new ListaCircularNinja();

        int opcao = -1;

        while (opcao != 0) {

            System.out.println("\n===== MENU NINJA (CIRCULAR SIMPLES / ORDENADO POR ID) =====");
            ...
            if (opcao == 1) {
                ...
                // Referência agora aponta para a classe Circular
                ListaCircularNinja.NinjaNode ninja = equipe.searchForId(id);
                ...
                // Agora o remove retorna boolean na nossa nova classe
                boolean removido = equipe.removeForId(id);
                if (removido) {
                    System.out.println("Ninja removido da equipe!");
                } else {
                    System.out.println("ID não encontrado.");
                }
            }
                ...
                System.out.println("Encerrando sistema ninja circular...");
            }
